...
export default async function DashboardPaiPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-[#0B0F19]">
      ...
      <div className="max-w-md w-full min-h-[85vh] md:min-h-[800px] bg-[#121826] rounded-[32px] border border-zinc-800/80 shadow-2xl overflow-hidden flex flex-col relative">
        ...
        <header className="p-6 flex justify-between items-center bg-[#161F30]/40 backdrop-blur-md border-b border-zinc-800/40">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5">Arapongas - PR</p>
          </div>
          <LogoutButton />
        </header>
        ...
        <main className="flex-1 w-full flex flex-col overflow-y-auto scrollbar-hide relative z-10">
          {aluno ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-[#1A2333]/60 backdrop-blur-lg border border-zinc-700/30 p-8 rounded-[24px] w-full shadow-xl">
                
                <svg xmlns="http://www.w3.org/2000/svg" className="text-blue-500 w-12 h-12 mb-4 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
