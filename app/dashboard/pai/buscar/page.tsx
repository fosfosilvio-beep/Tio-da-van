  ...
  return (
    <div className="min-h-[100dvh] w-full bg-background flex flex-col">
      <div className="relative z-10 flex flex-col h-full">
        {/* Header Dark Premium */}
        <header className="sticky top-0 z-50 bg-secondary/95 backdrop-blur-md border-b border-white/5 px-6 py-4 shadow-lg">
        ...
        <main className="flex-1 max-w-md w-full mx-auto p-6 space-y-8 overflow-y-auto pb-24 scrollbar-hide">
          <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-title font-bold text-foreground mb-2">Encontre seu Motorista</h2>
          ...
          {bairro && escola && (
            <section className="pt-2 animate-in fade-in slide-in-from-bottom-8 duration-700">
              <h3 className="font-title font-bold text-slate-200 text-lg mb-4 flex items-center gap-2">
                Resultados
                <span className="bg-primary/20 text-primary text-xs px-2.5 py-1 rounded-lg border border-primary/30">
              ...
              <div className="space-y-4">
                {motoristasEncontrados.length > 0 ? (
                  ...
                  <div className="text-center py-12 bg-secondary rounded-2xl border border-white/10 px-6">
